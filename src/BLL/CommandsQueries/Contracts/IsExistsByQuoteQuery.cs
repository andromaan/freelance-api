...
public record IsExistsByQuoteQuery : IRequest<Result<bool>>
{
...
public class IsExistsByQuoteQueryHandler(
    ...
    : IRequestHandler<IsExistsByQuoteQuery, Result<bool>>
{
    public async Task<Result<bool>> Handle(IsExistsByQuoteQuery request, CancellationToken cancellationToken)
    {
