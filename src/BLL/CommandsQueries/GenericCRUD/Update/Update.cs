...
public class Update
{
    public record Command<TUpdateViewModel, TKey, TViewModel> : IRequest<ServiceResponse<TViewModel?>>
    ...
    public class CommandHandler<TUpdateViewModel, TViewModel, TEntity, TKey, TQueries>(
        ...
        : IRequestHandler<Command<TUpdateViewModel, TKey, TViewModel>, ServiceResponse<TViewModel?>>
            ...
            CancellationToken cancellationToken)
        {
            ...
            if (request.Model is not ISkipAuditable)
            {
                if (existingEntity is AuditableEntity<TKey> auditable)
                {
                    ...
                    {
                        return ServiceResponse<TViewModel?>.Forbidden(
